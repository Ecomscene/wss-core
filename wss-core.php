...
define( 'WSS_CORE_VERSION', '1.13.0' );
...
require_once WSS_CORE_PATH . 'includes/class-wss-plugin-manager.php';
require_once WSS_CORE_PATH . 'includes/class-wss-webhook.php';
require_once WSS_CORE_PATH . 'includes/class-wss-sso.php';
